 ...
 <div class="content-wrapper">
     ...
     <div class="content">
         <div class="d-grid gap-2 d-md-block mb-2 ms-2">
             ...
             <!-- Modal -->
             <form method="post" action="<?=base_url('Admin/addPortofolio');?>" enctype="multipart/form-data">
             ...
             <div class="card-body p-2">
                 <table class="table table-striped projects">
                     ...
                     <tbody>
                         ...
                         <?php if (!empty($infoportofolio)) {$no = $this->uri->segment(3)
                         ;
    foreach ($infoportofolio as $s) {$no++;
        ?>
                         <tr>
                             <td scope="row"><?=$no?>.</td>
                             <td><?=$s['name']?></td>
                             ...
                             <td><?=$s['created']?></td>
                             <td><?=$s['modified']?></td>
                             <td><img src="<?= base_url('assets/img/portofolio/') . $s['image']; ?>"
                                     class="img-thumbnail" alt="Image"></td>
                             <td>
                                 ...
                                 <!-- Button edit -->
                                 <a href="<?php echo base_url('Admin/deletePortofolio/' . $s['id']); ?>"
                                 ...
                                 <form enctype="multipart/form-data"
                                     action="<?=base_url('Admin/editPortofolio/'. $s['id']);?>" method="POST">
                                                 ...
                                                 <div class="modal-body">
                                                     ...
                                                     <div class="mb-3">
                                                         ...
                                                         <select name="category" class="form-select"
                                                             ...
                                                             <option selected><?php echo $s['category']; ?></option>
                                                             <option value="Branding">Branding</option>
                                                             <option value="Desain">Desain</option>
                                                             <option value="Photography">Photography</option>
                                                         </select>
